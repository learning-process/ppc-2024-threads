...
TEST(ivlev_a_convex_hull_stl, one_component) {
  // Create data
  ...
  // Create Task
  ConvexHullSTLTaskSequential testTaskSequential(taskDataSeq);
  ...
  // Create Task
  ConvexHullSTLTaskParallel testTaskParallel(taskDataPar);
...
TEST(ivlev_a_convex_hull_stl, two_component) {
  // Create data
...
TEST(ivlev_a_convex_hull_stl, three_component) {
  // Create data
...
TEST(ivlev_a_convex_hull_stl, one_big_compnent) {
  // Create data
...
TEST(ivlev_a_convex_hull_stl, one_small_one_big) {
  // Create data
  std::vector<std::vector<std::pair<size_t, size_t>>> in = {
      {{0, 0}, {0, 1}, {1, 0}, {1, 1}},
