...
TEST(mirzakhmedov_a_ccs_matrix_mult, test_dft64x64) {
    int n = 64;
    double N = 64.0;
    CCSSparseMatrix A = dft_matrix(n);
    CCSSparseMatrix B = dft_conj_matrix(n);
...
TEST(mirzakhmedov_a_ccs_matrix_mult, test_shifting_diagonal) {
    int n = 256;
...
TEST(mirzakhmedov_a_ccs_matrix_mult, test_permutation_matrix) {
    int n = 257;
