...
TEST(shipitsin_v_rect_integral_seq, test_pipeline_run) {
  double res = 217.0907;
  Func f = shipitsin_fxexpy;
  uint64_t n = 5000;

  std::vector<double> in = {0, 5, 1, 2};
  ...
  auto testTaskSequential = std::make_shared<ShipitsinTaskSequential>(taskDataSeq);
