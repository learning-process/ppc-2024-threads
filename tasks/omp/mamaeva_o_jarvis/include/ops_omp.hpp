...
class JarvisHullOmp : public ppc::core::Task {
 public:
  explicit JarvisHullOmp(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
